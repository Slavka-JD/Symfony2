...
<head>
    ...
    <link href="bundles/sensiodistribution/webconfigurator/css/install.css" rel="stylesheet" type="text/css"
          media="all"/>
    ...
    <div id="symfony-content">
        <div class="symfony-blocks-install">
            ...
            <div class="symfony-block-content">
                ...
                <p>This script will guide you through the basic configuration of your project. You can also do the same
                    by editing the ‘<strong>app/config/parameters.ini</strong>’ file directly.</p>
                ...
                <?php if ($phpini): ?>
                    ...
                    <p>*
                        <?php if (get_cfg_var('cfg_file_path')): ?>
                            ...
                            <strong><?php echo get_cfg_var('cfg_file_path') ?></strong>".
                        <?php else: ?>
